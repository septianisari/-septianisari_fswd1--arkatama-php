...
<body>
        ...
        <div class="col-6 card shadow-lg border-0 m-5 p-5 mx-auto">
            <div class = "card-body">
        <form action="edituserfunc.php" method="post" enctype="multipart/form-data">
            ...
            <select  class="my-2" style="width: 90%; height :30%" name="role" value="<?php echo $row['role'];?>" 
            id="role" placeholder="Pilih Role Pengguna">
