...
function edit_user(){
    ...
    $query_update = "UPDATE users SET  name='$name', role='$role', password ='$password', email='$email', 
    phone='$phone', address='$address', avatar='$avatar',  created_at= NOW(), updated_at= NOW() WHERE id='$id'";
